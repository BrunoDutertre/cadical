...
#
# BD: this was /tmp/run-simplifier-....
# but we can't use /tmp/ until we fix src/Files.cpp
# to understand the Windows naming conventions.
#
prefix=run-simplifier-and-extend-solution-$$
